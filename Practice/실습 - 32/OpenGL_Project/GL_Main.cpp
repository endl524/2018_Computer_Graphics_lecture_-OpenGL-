...
void GL_Main::Key_Manager(unsigned char key, int x, int y)
{
	...
	case 'b':
		m_instance->m_Piramid_1->Normal_On_Switch();
		m_instance->m_Piramid_2->Normal_On_Switch();
		m_instance->m_Piramid_3->Normal_On_Switch();
		m_instance->m_Piramid_4->Normal_On_Switch();
		m_instance->m_Piramid_5->Normal_On_Switch();
		break;
	}
}
...
void GL_Main::Init_Objects()
{
	...
	m_instance->Build_Object(FLOOR_OBJECT);

	int num = 0;
	num = m_instance->Build_Object(PIRAMID_OBJECT);
	m_Piramid_1 = m_instance->Get_Object(num);
	num = m_instance->Build_Object(PIRAMID_OBJECT);
	m_Piramid_2 = m_instance->Get_Object(num);
	m_Piramid_2->Set_Translate(-200.0f, 0.0f, -200.0f);
	num = m_instance->Build_Object(PIRAMID_OBJECT);
	m_Piramid_3 = m_instance->Get_Object(num);
	m_Piramid_3->Set_Translate(-200.0f, 0.0f, 200.0f);
	num = m_instance->Build_Object(PIRAMID_OBJECT);
	m_Piramid_4 = m_instance->Get_Object(num);
	m_Piramid_4->Set_Translate(200.0f, 0.0f, 200.0f);
	num = m_instance->Build_Object(PIRAMID_OBJECT);
	m_Piramid_5 = m_instance->Get_Object(num);
	m_Piramid_5->Set_Translate(200.0f, 0.0f, -200.0f);
...
int GL_Main::Build_Object(const int& type)
{
	...
	case FLOOR_OBJECT:
		...
		temp_Object->Set_Material_Diffuse_Color(0.5f, 0.5f, 0.5f, 1.0f);
		temp_Object->Set_Material_Specular_Color(0.5f, 0.5f, 0.5f, 1.0f);
		break;
	...
	case SPOT_LIGHT_1_OBJECT:
		...
		if (!m_Spot_Light_1->Get_is_invalid_Light_Object())
		{
			...
			m_Spot_Light_1->Set_Light_Spot_CutOff(40.0f);
	...
	case SPOT_LIGHT_2_OBJECT:
		...
		if (!m_Spot_Light_2->Get_is_invalid_Light_Object())
		{
			...
			m_Spot_Light_2->Set_Light_Spot_CutOff(40.0f);
