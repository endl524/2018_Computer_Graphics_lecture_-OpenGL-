...
{
	Object* temp_Object = new Object(type, v_vertexs, m_Curr_Object_Num, pos_x, pos_y, size_x, size_y, m_Random_Dir_X(m_Random_SEED), m_Random_Dir_Y(m_Random_SEED), m_Random_Speed(m_Random_SEED));
	++m_Curr_Object_Num;
