...
public: // Getter, Setter 정의구역
	...
	virtual void Pitch(const float& value) { m_Rotate_Pitch_Value = value; }
	...
	virtual void Roll(const float& value) { m_Rotate_Roll_Value = value; }
	...
	float* Get_Collider_Box() { return m_Collider_Box; }
