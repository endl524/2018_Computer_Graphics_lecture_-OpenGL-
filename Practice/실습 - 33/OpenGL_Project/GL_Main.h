...
private: // 멤버변수 선언구역
	...
	uniform_real_distribution<> m_Random_Snow_Speed;
	uniform_int_distribution<> m_Random_Snow_Position;

	Light_Object* m_Spot_Light_1 = nullptr;
	Light_Object* m_Spot_Light_2 = nullptr;
	Object* m_Piramid[5] = { nullptr, };
	Object* m_Floor_Pieces[FLOOR_PIECE_HALF_COUNT * 2 + 1][FLOOR_PIECE_HALF_COUNT * 2 + 1] = { nullptr, };
	Object* m_Snow_Objects[20] = { nullptr, };
...
public: // public 메소드 정의구역
	...
	static void Start_Snow_Falling_Timer(const int object_num);
