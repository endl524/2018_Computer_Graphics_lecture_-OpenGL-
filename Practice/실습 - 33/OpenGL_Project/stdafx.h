...
#define FLOOR_PIECE_SIZE 2.0f
#define FLOOR_PIECE_HALF_COUNT 50
...
#define SNOW_INIT_POSITION_Y 400.0f
#define SNOW_FALLING_SPEED_MIN 1.0f
#define SNOW_FALLING_SPEED_MAX 3.0f
