...
private: // 멤버변수 선언구역
	...
	uniform_int_distribution<> m_Random_Direction;
	uniform_int_distribution<> m_Random_Round_Number;
...
public: // public 메소드 정의구역
	...
	Object* Make_Object(const GLenum& type, vector<Vertex2D>& v_vertexs, const float& pos_x, const float& pos_y, const bool& is_clockwise);
	void Set_Vertex(Vertex2D& temp_vertex, vector<Vertex2D>& v_vertexs, const float& pos_x, const float& pos_y, const bool& is_clockwise);
