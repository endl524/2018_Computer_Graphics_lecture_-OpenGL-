...
{
	if (m_Quaternion_Result != nullptr) delete m_Quaternion_Result;
	m_Quaternion_Result = new Quaternion();
	if (m_Quaternion_temp_1 != nullptr) delete m_Quaternion_temp_1;
	m_Quaternion_temp_1 = new Quaternion();
	if (m_Quaternion_temp_2 != nullptr) delete m_Quaternion_temp_2;
	m_Quaternion_temp_2 = new Quaternion();
	if (m_Quaternion_temp_3 != nullptr) delete m_Quaternion_temp_3;
